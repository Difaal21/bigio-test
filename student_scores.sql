...
--
-- Host: localhost    Database: bigio_test_student_scores
-- ------------------------------------------------------
...
CREATE TABLE `student_scores` (
  ...
  CONSTRAINT `student_scores_ibfk_1` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`id`),
  CONSTRAINT `student_scores_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
  CONSTRAINT `student_scores_ibfk_3` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`)
...
-- Dump completed on 2022-04-27  6:05:47
